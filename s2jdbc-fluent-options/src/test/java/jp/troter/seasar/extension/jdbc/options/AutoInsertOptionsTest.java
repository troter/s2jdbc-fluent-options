...
public class AutoInsertOptionsTest {

    public static class Entity {}

    AutoInsertOptions<Entity> s;
    AutoInsertOptions<Entity> o;

    @EasyMock(EasyMockType.STRICT)
    private AutoInsert<Entity> applied;

    @Before
    public void before() {
        s = new AutoInsertOptions<Entity>();
        o = new AutoInsertOptions<Entity>();
    }
